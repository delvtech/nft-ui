  ...
  return (
    <LoreContainer align="center">
      ...
      <div className="flex-div max-width">
        ...
        <p>
          Our magic will grow stronger together,” Jannalor replied.
          Experimenting with spices from their new neighbours, they turned to a
          crop called Bacchae, long outlawed in the Old World for being too
          degenerate.
        </p>
        <p>
          With these elements combined, they tamed the harvest’s boom and bust
          cycles, allowing spices to flow at a steady rate. This brought
          stability to their farming efforts, and to their newfound way of life.
        </p>
      </div>
    </LoreContainer>
  );
